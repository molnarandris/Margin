...
sealed class UndoableAction {
    ...
    data class MetadataChanged(val oldTitle: String, val newTitle: String, val oldAuthors: List<String>, val newAuthors: List<String>, val oldProjects: List<String>, val newProjects: List<String>, val oldPeople: List<String>, val newPeople: List<String>) : UndoableAction()
